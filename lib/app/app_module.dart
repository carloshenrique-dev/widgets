...
import 'package:widgets/app/modules/financial_data/financial_data_module.dart';
...
import 'package:widgets/app/modules/select_farm/select_farm_module.dart';
...
class AppModule extends Module {
  ...
  List<ModularRoute> get routes => [
        ChildRoute('/', child: (context, args) => const FinancialDataPage()),
